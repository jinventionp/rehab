...
class ContractsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'typecontract_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'contract_frequency' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => 'Frecuencia del Contrato (dias, mes), 1 mes corresponde a 30 dias calendario', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_contracts_typecontracts1_idx' => ['type' => 'index', 'columns' => ['typecontract_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_contracts_typecontracts1' => ['type' => 'foreign', 'columns' => ['typecontract_id'], 'references' => ['typecontracts', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
